...
const KNOWN_VALIDATORS = {
  testnet: [
    ...
    { name: 'Chorus One', city: 'Berlin', lat: 52.52, lon: 13.41, region: 'Europe' },
    { name: 'P2P.org', city: 'Amsterdam', lat: 52.37, lon: 4.90, region: 'Europe' },
    { name: 'Everstake', city: 'Tallinn', lat: 59.44, lon: 24.75, region: 'Europe' },
    { name: 'HashKey Cloud', city: 'Hong Kong', lat: 22.32, lon: 114.17, region: 'Asia' },
    { name: 'Luganodes', city: 'Singapore', lat: 1.35, lon: 103.82, region: 'Asia' },
    { name: 'Blockdaemon', city: 'New York', lat: 40.75, lon: -73.98, region: 'North America' },
    ...
    { name: 'InfStones', city: 'San Jose', lat: 37.34, lon: -121.89, region: 'North America' },
    { name: 'Allnodes', city: 'Miami', lat: 25.76, lon: -80.19, region: 'North America' },
    { name: 'StakingCabin', city: 'Taipei', lat: 25.03, lon: 121.57, region: 'Asia' },
    ...
    { name: 'Validation Cloud', city: 'London', lat: 51.51, lon: -0.13, region: 'Europe' },
    { name: 'CertHum', city: 'Istanbul', lat: 41.01, lon: 28.98, region: 'Europe' },
    { name: 'DeSpread', city: 'Seoul', lat: 37.55, lon: 127.00, region: 'Asia' },
    { name: 'Nodes.Guru', city: 'Helsinki', lat: 60.17, lon: 24.94, region: 'Europe' },
