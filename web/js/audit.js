  ...
  <section class="data-section audit-section">
    ...
    ${zeroList.length ? `
      ...
      <div class="audit-flag audit-flag-info">
        ...
        ${unknownTenureCount > 0 ? `<div style="margin-top:6px;font-size:11px;color:var(--text-dim)">Plus ${unknownTenureCount} self-bonded operators (no resolvable Foundation-delegate tenure).</div>` : ""}
